...
def train(model, train_loader, test_loader, optimizer, criterion, num_epochs, device, save_path="handwritten_digit_model_weights.pth"):
    """
...
if train_loader is not None and test_loader is not None:
    ...
    if model is not None:
        ...
        train(model, train_loader, test_loader, optimizer, criterion, num_epochs, device, save_path=model_save_path)
